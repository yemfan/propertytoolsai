-- Run in Supabase SQL Editor if you see 42P01: relation "public.entitlement_usage_daily" does not exist.
-- Requires: public.profiles(id), public.set_updated_at() (from profiles migrations).
