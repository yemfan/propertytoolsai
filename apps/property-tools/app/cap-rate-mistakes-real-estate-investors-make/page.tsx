...
export default function CapRateMistakesRealEstateInvestorsMakePage() {
  ...
  const url = "https://propertytoolsai.com/cap-rate-mistakes-real-estate-investors-make";
    ...
    <div className="w-full max-w-6xl py-10">
      ...
      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        ...
        <p>
          ...
          in PropertyTools AI lets you explicitly include a vacancy assumption in your analysis.
        </p>
      </section>
