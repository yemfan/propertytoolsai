...
export default function HowCapRateAffectsPropertyValuePage() {
  ...
  const url = "https://propertytoolsai.com/how-cap-rate-affects-property-value";
    ...
    <div className="w-full max-w-6xl py-10">
      ...
      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        ...
        <p>
          ...
          in PropertyTools AI can help you visualize how different NOI and cap rate scenarios impact
          value over time.
        </p>
      </section>
