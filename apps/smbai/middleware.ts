/**
 * Next.js middleware — auth + org guard for dashboard routes.
 * Renamed from proxy.ts (which was never wired as Next.js middleware).
 */
...
export async function middleware(request: NextRequest) {
  ...
  if (isDashboard) {
    ...
    // Check for org — accept either cookie name (old smbai-org-id or new helmsmart-org-id)
    const orgId =
