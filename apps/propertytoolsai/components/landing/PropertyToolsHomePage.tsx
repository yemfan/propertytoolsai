            ...
            {tools.map((tool, i) => (
              <Reveal key={tool.title} delay={i * 70} className={tool.featured ? "md:col-span-2 md:row-span-2" : ""}>
                ...
                >
                  ...
                  <div
                    className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-[#0072ce] opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100 dark:text-[#4da3e8]"
                    aria-hidden
                  >
                    Try free
