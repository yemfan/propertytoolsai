    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden px-4 pb-8 pt-20 text-center md:px-6 md:pb-12 md:pt-28 lg:pt-32">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <h1 className="font-heading text-4xl font-extrabold leading-[1.08] tracking-tight text-gray-950 sm:text-5xl lg:text-6xl" style={{ animation: "fadeInUp 0.7s ease-out 0.08s both" }}>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600 md:text-xl" style={{ animation: "fadeInUp 0.7s ease-out 0.16s both" }}>
            AI calculators that give you <strong className="text-gray-900">real numbers</strong> — not ballpark guesses. Trusted by buyers, sellers, and investors making smarter decisions.
          </p>
      ...
      <section id="tools" className="px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-6xl">
          <Reveal className="text-center">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-gray-900 md:text-4xl">Real Estate Tools That Actually Help</h2>
          </Reveal>
            ...
            {tools.map((tool, i) => (
              <Reveal key={tool.title} delay={i * 70} className={tool.featured ? "md:col-span-2 md:row-span-2" : ""}>
                ...
                >
                  ...
                  <h3 className={`font-heading font-bold text-gray-900 transition-colors group-hover:text-[#0072ce] ${tool.featured ? "text-xl" : "text-base"}`}>
                    {tool.title}
                  </h3>
                  <p className={`mt-2 flex-1 leading-relaxed text-gray-600 ${tool.featured ? "text-base" : "text-sm"}`}>
                    {tool.description}
                  </p>
      ...
      <section className="bg-slate-50 px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-6xl">
          <Reveal className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 md:text-4xl">Trusted by Real People</h2>
            <p className="mt-3 text-base text-gray-500">Hear from buyers, sellers, and investors who use our tools</p>
          </Reveal>
      ...
      <section id="pricing" className="px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <Reveal>
            <h2 className="text-3xl font-extrabold text-gray-900 md:text-4xl">Simple, Transparent Pricing</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-5 text-base leading-relaxed text-gray-600">
              PropertyTools drives traffic. <strong className="text-gray-900">LeadSmart AI</strong> converts it into closed deals — instant AI follow-up, lead scoring, and automated nurture sequences.
            </p>
            ...
            <a href={LEADSMART_URL} target="_blank" rel="noopener noreferrer" className="group mt-8 inline-flex items-center gap-2 rounded-2xl bg-gray-900 px-7 py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:bg-gray-800 hover:shadow-lg active:scale-[0.97]">
              See LeadSmart AI
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={l} className="rounded-xl bg-slate-50 p-3.5 text-center transition-all duration-200 hover:bg-slate-100">
                    ...
                    <p className="mt-0.5 text-[10px] font-medium text-gray-500">{l}</p>
                  </div>
                ))}
              </div>
              <div className="mt-4">
      ...
      <section className="px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-3xl">
          <Reveal className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Questions? We&apos;ve Got Answers</h2>
          </Reveal>
