...
/**
 * GET /api/mobile/leads-gen/recurring/list
 *
 * Mobile-side counterpart to /api/leads-gen/recurring/list.
 * Returns the agent's recurring post schedules with social-account
...
export async function GET(req: Request) {
  ...
  try {
    ...
    if (rows.length === 0) {
      return NextResponse.json({ ok: true, success: true, recurrences: [] });
    }
    ...
    console.error("[mobile/leads-gen/recurring/list]", e);
