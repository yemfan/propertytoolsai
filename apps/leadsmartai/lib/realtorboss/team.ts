/**
 * RealtorBoss AI team roster — UI metadata for the four assistants.
 * Mirrors the HelmSmart `CORE_ROSTER` blueprint shape so Phase 2 can
 * promote these to `ai_assistants` DB rows without renaming anything.
 */
...
export type AssistantDef = {
  ...
  mission: string;
  href: string;
  /** Skill keys from lib/ai/prompts/realtorboss/skills.ts */
