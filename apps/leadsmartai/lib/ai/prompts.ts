...
/** Inputs for a Financial Needs Analysis (FNA) report — financial-services vertical. */
...
- Income replacement need (10x household income): ${incomeRepl}
- DIME total (Debt + Income x 10 + Mortgage + Education estimate): ${dime}
...
Plain-language paragraph + short bullet recap.
