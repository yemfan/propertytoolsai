-- =============================================================================
-- Delete ONE auth user safely (shared Supabase: LeadSmart + PropertyTools).
--
-- What this does:
...
-- Or: replace the UUID and apply via `node scripts/apply-supabase-sql-remote.mjs`
--     after editing a copy of this file (do not commit real UUIDs).
--
