...
export default function CapRateVsCashOnCashReturnPage() {
  ...
  const url = "https://propertytoolsai.com/cap-rate-vs-cash-on-cash-return";
    ...
    <div className="container mx-auto px-4 py-10">
      ...
      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        ...
        <p>
          ...
          in PropertyToolsAI to model cap rate, cash on cash return, and long-term ROI in one view.
        </p>
        <p>
